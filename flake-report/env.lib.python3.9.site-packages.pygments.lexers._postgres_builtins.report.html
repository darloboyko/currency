...
<html>
   <head>
      <title>flake8 violations: env/lib/python3.9/site-packages/pygments/lexers/_postgres_builtins.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.lib.python3.9.site-packages.pygments.lexers._postgres_builtins.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.lib.python3.9.site-packages.pygments.lexers._postgres_builtins.source.html#l624">
