...
urlpatterns = [
    path('contacts/list/', currency_views.ContactUsList.as_view(), name='contact_list'),
    path('contact-us/create/', currency_views.ContactUsCreate.as_view(), name='contactus_create'),
    path('rates/list/', currency_views.RateList.as_view(), name='rate_list'),
    path('rates/create/', currency_views.RateCreate.as_view(), name='rate_create'),
    path('rates/update/<int:pk>/', currency_views.RateUpdate.as_view(), name='rate_update'),
    path('rates/delete/<int:pk>/', currency_views.RateDelete.as_view(), name='rate_delete'),
